...
import { CoursesArray} from '../../models';
...
const Clubinterimscreen = () => {
  ...
  const pass_schoolname = (item) => {
      ...
      navigation.navigate('coursesHomeScreen', {
      schoolname: new1,
  ...
  const get_data = async() => {
    const posts = await DataStore.query(CoursesArray, (p) =>
   ...
   // <ImageBackground source={image2} resizeMode="cover" style={styles.image}>
      <View style={styles.container}>
        ...
        <Text style={styles.titleText}>
          Find your School's Courses
        </Text>
        <Entypo name="book" size={100} color="black" style = {{alignSelf: 'center',}} />
        <SearchableDropdown
        ...
        />
        <Text style={styles.headingText} > Don't see your Course? 
